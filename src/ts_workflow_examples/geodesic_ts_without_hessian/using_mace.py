...
def geodesic_ts_no_hess_irc_mace(reactant, product, calc_kwargs, logger, clean_up=True):
    ...
    job2 = strip_decorator(ts_job)(job1['highest_e_atoms'], use_custom_hessian=False, **calc_kwargs)
...
if __name__ == "__main__":
    ...
    job1, job2, job3, job4 = geodesic_ts_no_hess_irc_mace(reactant, product, calc_kwargs, logger)
    print('\n\n', job1)
    print('\n\n', job2)
    print('\n\n', job3)
    print('\n\n', job4)
