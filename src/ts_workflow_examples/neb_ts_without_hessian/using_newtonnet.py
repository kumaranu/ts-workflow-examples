...
def neb_ts_no_hess_irc_newtonnet(reactant, product, calc_kwargs1, logger, clean_up=True):
    # Create NEB job
...
if __name__ == "__main__":
    ...
    job1, job2, job3, job4 = neb_ts_no_hess_irc_newtonnet(reactant, product, calc_kwargs1, logger)
    print('\n\n', job1)
    print('\n\n', job2)
    print('\n\n', job3)
    print('\n\n', job4)
